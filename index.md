...
2. Each scheduled dose produces an administration record (`MedicationAdministrationAdherence`).
3. A periodic summary captures adherence as a percentage or coded assessment (`AdherenceObservation`).
